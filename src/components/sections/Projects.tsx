  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={onClose}
          className="fixed top-6 right-6 z-[1110] w-10 h-10 flex items-center justify-center border border-white/10 bg-[#0A0A0A] text-white/40 hover:border-[#CC1500] hover:text-white transition-all rounded-lg"
        >
          <X size={17} />
        </button>
              ...
              <div className="grid grid-cols-2 gap-2">
                {before.map((img, idx) => (
                  <motion.div
                    ...
                    className={`group relative overflow-hidden bg-zinc-900 cursor-zoom-in rounded-xl ${idx === 0 ? "col-span-2 aspect-[16/9]" : "aspect-[4/3]"}`}
                  >
                    ...
                    <div className="absolute bottom-3 left-3">
                      <span className="px-2.5 py-1 bg-white/5 border border-white/10 text-white/40 text-[9px] uppercase tracking-widest font-black rounded" style={{ fontFamily: "Poppins, sans-serif" }}>
                        {idx + 1} / {before.length}
                      </span>
                    </div>
                  </motion.div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {after.map((img, idx) => (
                  ...
                  >
                    ...
                    />
                    <div className="absolute bottom-3 left-3">
                      <span className="px-2.5 py-1 bg-[#CC1500] text-white text-[9px] uppercase tracking-widest font-black rounded" style={{ fontFamily: "Poppins, sans-serif" }}>
                        {idx + 1} / {after.length}
                      </span>
                    </div>
                  </motion.div>
      ...
      <div className="max-w-7xl mx-auto w-full relative z-20">
        ...
        <div className="mb-10 text-center">
          <motion.h2
            ...
            className="flex flex-wrap items-baseline justify-center gap-x-3 font-black uppercase leading-[0.88]"
            style={{ fontFamily: "Poppins, sans-serif", fontSize: "clamp(2rem, 6vw, 5.5rem)", letterSpacing: "-0.02em" }}
          >
          ...
          {visibleProjects.map((p, i) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative overflow-hidden cursor-pointer bg-[#0A0A0A] aspect-[16/9] rounded-2xl${isLast ? " md:col-span-2 md:aspect-[32/9]" : ""}`}
              >
                {/* media */}
                <motion.div
                        ...
                        <div className="flex items-center gap-3 mb-4">
                          {p.liveUrl && (
                            <a
                              ...
                              rel="noreferrer"
                              onClick={e => e.stopPropagation()}
                              className="flex items-center gap-2 px-4 py-2 bg-white text-black font-black text-[10px] uppercase tracking-widest hover:bg-[#CC1500] hover:text-white transition-all rounded-full"
                              style={{ fontFamily: "Poppins, sans-serif" }}
                            >
                          ...
                          {p.process && (
                            <button
                              ...
                              className="flex items-center gap-2 px-4 py-2 border border-white/20 text-white/60 font-black text-[10px] uppercase tracking-widest hover:border-white/50 hover:text-white transition-all rounded-full"
                              style={{ fontFamily: "Poppins, sans-serif" }}
                            >
                              <Eye size={11} />
                              {lang === "en" ? "Process" : "Proceso"}
        ...
        <div className="flex justify-center mt-12">
          <button
            ...
            className="group flex items-center gap-2 px-8 py-4 bg-transparent border border-[#0A0A0A]/10 hover:border-[#CC1500] hover:text-[#CC1500] text-[#0A0A0A] font-black text-[10px] uppercase tracking-[0.25em] transition-all duration-300 rounded-full"
            style={{ fontFamily: "Poppins, sans-serif" }}
          >
            {expanded
          ...
          <>
            ...
            <div className="fixed inset-0 z-[1001] flex items-center justify-center p-4 md:p-10 pointer-events-none">
              <motion.div
                ...
                className="relative w-full max-w-5xl bg-[#111] border border-white/8 pointer-events-auto overflow-hidden max-h-[90vh] flex flex-col rounded-2xl"
              >
                ...
                <div className="flex items-center justify-between px-6 md:px-10 py-4 border-b border-white/[0.06] shrink-0">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      onClick={() => setSelectedId(null)}
                      className="w-9 h-9 flex items-center justify-center border border-white/10 bg-white/[0.03] text-white/40 hover:border-[#CC1500] hover:text-white transition-all rounded-lg"
                    >
                      <X size={15} />
                    </button>
                  </div>
                      ...
                      <div className="space-y-7">
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {selected.stack.map(tech => (
                              <span key={tech} className="px-4 py-2 bg-white/5 text-[10px] text-white/40 font-black uppercase border border-white/5 flex items-center gap-2 rounded-full" style={{ fontFamily: "Poppins, sans-serif" }}>
                        ...
                        {selected.liveUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="flex items-center justify-center gap-3 py-4 bg-white text-black font-black text-[10px] uppercase tracking-widest hover:bg-[#CC1500] hover:text-white transition-all group rounded-full"
                            style={{ fontFamily: "Poppins, sans-serif" }}
                          >
                            {lang === "en" ? "Visit site" : "Ver sitio"}
