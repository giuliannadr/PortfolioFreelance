...
export const ProfileCard = ({
  ...
  return (
    <motion.div
      className="flex justify-center cursor-pointer px-4 sm:px-0"
    ...
    >
      <div className="relative w-[320px] sm:w-[360px] md:w-[380px] lg:w-[400px] bg-white rounded-[28px] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.25)] border border-gray-200/70 p-5 sm:p-6 md:p-7 overflow-visible">
        ...
        <h3
  className="text-[20px] sm:text-[24px] md:text-[28px] lg:text-[32px] xl:text-[36px] font-extrabold leading-tight text-center"
  style={{ fontFamily: "'Poppins', sans-serif" }}
>
  <span className="block sm:inline">Giuliana </span>
  <span className="block sm:inline">Di Rocco</span>
</h3>
